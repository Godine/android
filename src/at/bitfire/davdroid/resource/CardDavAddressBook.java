...
public class CardDavAddressBook extends at.bitfire.davdroid.resource.RemoteCollection<at.bitfire.davdroid.resource.Contact> {
	...
	@Override
	protected at.bitfire.davdroid.resource.Contact newResourceSkeleton(String name, String ETag) {
		return new at.bitfire.davdroid.resource.Contact(name, ETag);
	}
