...
public class Event extends at.bitfire.davdroid.resource.Resource {
	...
	public void parseEntity(@NonNull InputStream entity, AssetDownloader downloader) throws IOException, at.bitfire.davdroid.resource.InvalidResourceException {
		...
		try {
			...
			if (ical == null)
				throw new at.bitfire.davdroid.resource.InvalidResourceException("No iCalendar found");
		...
		if (events == null || events.isEmpty())
			throw new at.bitfire.davdroid.resource.InvalidResourceException("No VEVENT found");
		...
		if (master == null)
			throw new at.bitfire.davdroid.resource.InvalidResourceException("No VEVENT without RECURRENCE-ID found");
	...
	protected void fromVEvent(VEvent event) throws at.bitfire.davdroid.resource.InvalidResourceException {
		...
		if ((dtStart = event.getStartDate()) == null || (dtEnd = event.getEndDate()) == null)
			throw new at.bitfire.davdroid.resource.InvalidResourceException("Invalid start time/end time/duration");
