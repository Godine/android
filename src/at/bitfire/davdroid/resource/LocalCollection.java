 ...
 */
public abstract class LocalCollection<T extends at.bitfire.davdroid.resource.Resource> {
	...
	abstract public String getCTag() throws at.bitfire.davdroid.resource.LocalStorageException;
	/** sets the CTag of the collection */
	abstract public void setCTag(String cTag) throws at.bitfire.davdroid.resource.LocalStorageException;
	...
	public long[] findNew() throws LocalStorageException {
		...
		try {
			@Cleanup Cursor cursor = providerClient.query(entriesURI(),
					...
					where, null, null);
			if (cursor == null)
				throw new at.bitfire.davdroid.resource.LocalStorageException("Couldn't query new records");
	...
	public long[] findUpdated() throws LocalStorageException {
		...
		try {
			@Cleanup Cursor cursor = providerClient.query(entriesURI(),
					...
					where, null, null);
			if (cursor == null)
				throw new at.bitfire.davdroid.resource.LocalStorageException("Couldn't query updated records");
	 ...
	 * @throws at.bitfire.davdroid.resource.LocalStorageException when the content provider couldn't be queried
	 */
	public long[] findDeleted() throws at.bitfire.davdroid.resource.LocalStorageException {
		...
		try {
			@Cleanup Cursor cursor = providerClient.query(entriesURI(),
					...
					where, null, null);
			if (cursor == null)
				throw new at.bitfire.davdroid.resource.LocalStorageException("Couldn't query dirty records");
	 ...
	 * @throws at.bitfire.davdroid.resource.LocalStorageException when the content provider couldn't be queried
	 */
	public T findById(long localID, boolean populate) throws at.bitfire.davdroid.resource.LocalStorageException {
		try {
	 ...
	 * @throws at.bitfire.davdroid.resource.LocalStorageException when the content provider couldn't be queried
	 */
	public T findByRemoteName(String remoteName, boolean populate) throws at.bitfire.davdroid.resource.LocalStorageException {
	...
	public abstract void populate(at.bitfire.davdroid.resource.Resource record) throws at.bitfire.davdroid.resource.LocalStorageException;
	...
	public void add(at.bitfire.davdroid.resource.Resource resource) throws at.bitfire.davdroid.resource.LocalStorageException {
	...
	public void updateByRemoteName(at.bitfire.davdroid.resource.Resource remoteResource) throws at.bitfire.davdroid.resource.LocalStorageException {
	...
	public int deleteAllExceptRemoteNames(at.bitfire.davdroid.resource.Resource[] remoteResources) throws at.bitfire.davdroid.resource.LocalStorageException {
		...
		if (remoteResources.length != 0) {
			...
			for (final at.bitfire.davdroid.resource.Resource res : remoteResources)
        ...
        try {
            ...
            throw new at.bitfire.davdroid.resource.LocalStorageException("Couldn't delete local resources", e);
        }
    }


	/** Updates the locally-known ETag of a resource. */
	public void updateETag(at.bitfire.davdroid.resource.Resource res, String eTag) throws at.bitfire.davdroid.resource.LocalStorageException {
	 ...
	 */
	protected abstract Builder buildEntry(Builder builder, at.bitfire.davdroid.resource.Resource resource, boolean update);

	/** Enqueues adding extra data rows of the resource to the local collection. */
	protected abstract void addDataRows(at.bitfire.davdroid.resource.Resource resource, long localID, int backrefIdx);
	
	/** Enqueues removing all extra data rows of the resource from the local collection. */
	protected abstract void removeDataRows(at.bitfire.davdroid.resource.Resource resource);
}
