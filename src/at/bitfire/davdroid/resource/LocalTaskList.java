...
// TO BE DELETED - Mohamed-Amine LECHGAR
...
public class LocalTaskList extends at.bitfire.davdroid.resource.LocalCollection<at.bitfire.davdroid.resource.Task> {
	...
	public static Uri create(Account account, ContentResolver resolver, at.bitfire.davdroid.resource.ServerInfo.ResourceInfo info) throws at.bitfire.davdroid.resource.LocalStorageException {
		@Cleanup("release") final ContentProviderClient client = resolver.acquireContentProviderClient(TASKS_AUTHORITY);
		if (client == null)
			throw new at.bitfire.davdroid.resource.LocalStorageException("No tasks provider found");
	...
	public String getCTag() throws at.bitfire.davdroid.resource.LocalStorageException {
		try {
			...
			if (c != null && c.moveToFirst())
				...
				throw new at.bitfire.davdroid.resource.LocalStorageException("Couldn't query task list CTag");
		} catch(RemoteException e) {
			throw new at.bitfire.davdroid.resource.LocalStorageException(e);
		}
	}
	...
	@Override
	public at.bitfire.davdroid.resource.Task newResource(long localID, String resourceName, String eTag) {
		return new at.bitfire.davdroid.resource.Task(localID, resourceName, eTag);
	}


	@Override
	public void populate(at.bitfire.davdroid.resource.Resource record) throws at.bitfire.davdroid.resource.LocalStorageException {
		try {
			...
			at.bitfire.davdroid.resource.Task task = (at.bitfire.davdroid.resource.Task)record;
			...
			throw new at.bitfire.davdroid.resource.LocalStorageException("Couldn't process locally stored task", e);
		}
	}

	@Override
	protected ContentProviderOperation.Builder buildEntry(ContentProviderOperation.Builder builder, at.bitfire.davdroid.resource.Resource resource, boolean update) {
		final at.bitfire.davdroid.resource.Task task = (at.bitfire.davdroid.resource.Task)resource;
